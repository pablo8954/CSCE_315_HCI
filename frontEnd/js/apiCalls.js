...
function createCustomJSON(srcCity, desCity, srcCountryCode, desCountryCode)
{
  ...
  sessionStorage.setItem('travel_json', JSON.stringify(travelJSONObj));
  console.log(travelJSONObj);
  console.log(JSON.stringify(travelJSONObj));
  alert("CHECK");
  return travelJSONObj;
...
function flightNumberParse()
{
  ...
  //TODO: only send info to database if info is valid
